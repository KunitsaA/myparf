<a href="admin.php?c=Articles_Object">Добавить объект</a>

<form action="admin.php?c=Articles_List" method="post">
...
//$img_status = ($d['status']==1) ? 'Ok_icon.png' : 'Not_icon.png'; ?>
  ...
  <tr style="background-color:<?=($a%2?"#EEE;":"#FFFFFF;")?>">
    ...
    <td align="center"><a class="EditLink" href="admin.php?c=Articles_Object&id=<?=$d['id']?>"><img src="img/Edit_icon.png" title="Редактировать" border="0" /></a></td>
