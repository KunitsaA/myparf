...
$(document).ready(function(e) {
	...
	function Add_Row(e)
	{
		...
		$('<tr><td align="center"></td><td><input class="styler" name="name" type="text" placeholder="Название" maxlength="50"></td><td align="center"><button class="styler" name="save" type="button">Ok</button></td></tr>').insertAfter('.List tr:first').trigger('refresh');;
	...
	$('.List').on('click','button[name="save"]',function(){
		...
		if(Name!='')
		{
			...
			$.ajax({
				 type: "POST",
				 data: {name:Name},
				 url: 'controllers/admin/Edit_Brands_controller.php',
				 dataType: "json",
				 success: function(data){
					  if (data !== false)
							{
								TrElem.remove();
								$('<tr style=""><td align="center"><input name="id[]" type="checkbox" value="'+data+'"></td><td>'+Name+'</td><td align="center"><a class="DeleteThis" data-id="'+data+'" href="#"><img src="img/Delete_icon.png" title="Удалить" border="0" /></a></td></tr>').insertAfter('.List tr:first');
								HideModal();
							}
					  else
							{
