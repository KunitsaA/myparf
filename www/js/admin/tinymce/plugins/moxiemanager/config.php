...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/user_img/";  ///webroot/uploads';
...
$moxieManagerConfig['thumbnail.width'] = 220;
$moxieManagerConfig['thumbnail.height'] = 190;
...
// Authentication
$moxieManagerConfig['authenticator'] = ''; //BasicAuthenticator - метод аутентификации
